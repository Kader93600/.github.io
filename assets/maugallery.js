(function ($) {
	...
	$.fn.mauGallery.methods = {
		...
		prevImage() {
			...
			next =
				imagesCollection[index-1] || // Ajout à l'index "-1"
		...
		nextImage() {
			...
			next = imagesCollection[index+1] || imagesCollection[0];  // Ajout à l'index "+1"
			$(".lightboxImage").attr("src", $(next).attr("src"));
		},
		...
		filterByTag() {
			...
			$(".nav-link").removeClass("active"); // Supprimer la classe 'active' de tous les éléments de navigation
